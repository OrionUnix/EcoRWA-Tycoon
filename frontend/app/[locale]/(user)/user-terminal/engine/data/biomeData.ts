...
export const BIOME_SIGNATURES: Record<number, BiomeRule> = {
    [BiomeType.DEEP_OCEAN]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0, intensity: 0 }, fish: { chance: 0.8, intensity: 1.0 }, // ✅ Wood 0
    ...
    [BiomeType.OCEAN]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0, intensity: 0 }, fish: { chance: 0.6, intensity: 0.8 }, // ✅ Wood 0
    ...
    [BiomeType.BEACH]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0.1, intensity: 0.2 }, fish: { chance: 0.2, intensity: 0.3 }, // ✅ Wood 0 (était 0.1)
    ...
    [BiomeType.PLAINS]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0.4, intensity: 0.5 }, fish: { chance: 0, intensity: 0 }, // ✅ Wood 0 (était 0.2)
    ...
    [BiomeType.FOREST]: {
        ...
        wood: { chance: 1.0, intensity: 1.0 }, animals: { chance: 0.9, intensity: 1.0 }, fish: { chance: 0, intensity: 0 }, // ✅ Wood reste actif ici uniquement
    ...
    [BiomeType.DESERT]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0.1, intensity: 0.1 }, fish: { chance: 0, intensity: 0 }, // ✅ Wood 0
    ...
    [BiomeType.MOUNTAIN]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0.2, intensity: 0.4 }, fish: { chance: 0, intensity: 0 }, // ✅ Wood 0 (était 0.2)
    ...
    [BiomeType.SNOW]: {
        ...
        wood: { chance: 0, intensity: 0 }, animals: { chance: 0.1, intensity: 0.2 }, fish: { chance: 0, intensity: 0 }, // ✅ Wood 0 (était 0.1)
