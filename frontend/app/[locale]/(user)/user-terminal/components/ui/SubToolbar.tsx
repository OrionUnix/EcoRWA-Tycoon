...
export const SubToolbar: React.FC<SubToolbarProps> = ({
    ...
    const TITLES: Record<string, string> = {
        ROADS: '🛣️ Routes',
        ZONES: '🏘️ Zones',
        [BuildingCategory.SERVICES]: '🏛️ Services',
        [BuildingCategory.UTILITIES]: '⚡ Énergie & Eau',
        [BuildingCategory.EXTRACTION]: '⛏️ Industrie & Extraction',
        [BuildingCategory.LEISURE]: '🎡 Loisirs & Culture',
        RWA: '🌍 RWA / GameFi',
