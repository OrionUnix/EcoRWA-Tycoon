...
const BUILDING_ICON_MAP: Record<string, { icon: string; color: string }> = {
    ...
    PHARMACY: { icon: '💊', color: '#D0021B' },
    RESTAURANT: { icon: '🍽️', color: '#F5A623' },
    CAFE: { icon: '☕', color: '#795548' },
    STADIUM: { icon: '🏟️', color: '#7B61FF' },
    WIND_TURBINE: { icon: '💨', color: SC_COLORS.power },
    SOLAR_PANEL: { icon: '☀️', color: SC_COLORS.power },
    MINE: { icon: '⛏️', color: '#607D8B' },
