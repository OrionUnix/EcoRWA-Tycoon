...
## 📖 Project Overview
**EcoRWA Tycoon** is a decentralized crowdfunding platform that makes investing in Real World Assets (RWA) as simple and engaging as playing a city-building game.

We tackle the three biggest barriers to entry in real estate:
